...
class Ellipsoid {
  ...
  public:
    ...
    bool noPointsInside(vector<Vec3f>& pc, const Eigen::Matrix3d R, const Vec3f& r, const Vec3f& p) {
    ...
    bool pointsInside(const Eigen::Matrix3Xd& pc, Eigen::Matrix3Xd& out, int& min_pt_id) {
    ...
    void Visualize(const ros::Publisher& pub, Color color = Color::Orange()) {
